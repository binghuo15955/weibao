...
<html class="x-admin-sm">
	...
	<body style="background: white;">
		<div class="layui-fluid">
			<div class="layui-row">
				<form class="layui-form layui-form-pane" lay-filter="message" id="message">
					...
					<div class="layui-form-item" style="padding-left: 20px;">
						<div class="layui-form-item">
							<div class="layui-col-md12">
								...
								<div class="layui-input-inline">
									<input type="text" id="name" name="name" lay-verify="required" placeholder="不可输入字符，例如：&，+，=等"
						...
						<div class="layui-form-item">
							<div class="layui-col-md6">
								...
								<div class="layui-upload">
								  <button type="button" class="layui-btn" id="test2">多图片上传</button>可以上传您的购买截图，增加成交率！
						...
						<div class="layui-form-item">
							<div class="layui-col-md6">
								...
								<div class="layui-input-inline">
									<input type="text" id="quality" name="quality" lay-verify="required|number" autocomplete="off" class="layui-input" value="1"
									 placeholder="输入你的商品数量">
								</div>
							</div>
						</div>
						...
						<div class="layui-form-item">
							<div class="layui-col-md12">
								<div class="layui-form-item x-city" id="start">
									...
									<div class="layui-input-inline">
										<select name="province" lay-filter="province" lay-search id="province">
									...
									<div class="layui-input-inline">
										<select name="area" lay-filter="area" lay-search id="area">
						...
						<div class="layui-form-item" id="btn" style="text-align: center;">
							...
							<button class="layui-btn layui-btn-danger layui-btn-lg" lay-filter="continue" lay-submit="">确认发布，并添加下一个商品</button>
						</div>
				</form>
			</div>
		</div>
						...
						success: function(res) { //res为相应体,function为回调函数
							...
							if (res == "success") {
								layer.msg('发布成功', {
									...
									var province_select='dd[lay-value=' + param.province + ']';
									var city_select='dd[lay-value=' +  param.city + ']';
									var area_select='dd[lay-value=' +  param.area + ']';
