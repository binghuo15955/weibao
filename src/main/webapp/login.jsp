...
<body class="login-bg">
	...
	<div class="login layui-anim layui-anim-up">
		...
		<form method="post" class="layui-form">
			...
			<hr class="hr15">
			<span>我是管理员</span>&emsp;<input type="checkbox" name="isAdmin" lay-skin="switch">
			<hr class="hr15">
				...
				form.on('submit(login)', function(data) {
					...
					$.ajax({
						...
						success : function(obj) {
							...
							if (obj == "success"&&param.isAdmin!="on") {
								layer.msg('登录成功', {
									icon : 1,
									time : 1500
								}, function() {
							...
							}else if(obj=="success"&&param.isAdmin=="on"){
									layer.msg('管理员登录成功', {
										icon : 1,
										time : 1500
									}, function() {
										//关闭当前frame
										parent.location.href = "manage-index.jsp";
										var index = parent.layer
												.getFrameIndex(window.name);
										//关闭当前frame
										parent.layer.close(index)
