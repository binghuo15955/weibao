...
<style>
.layui-form-item .layui-col-md4 input{
	border:0em;
}
.layui-form-item .layui-col-md2 input{
	border:0em;
}
.layui-form-item .layui-col-md4 label{
width:100px
}
.layui-form-item .layui-col-md2 label{
width:100px
}
</style>
<body>
			...
			<form class="layui-form layui-form-pane" lay-filter="record">
				...
				<div class="layui-form-item">
					<div class="layui-col-md4">
						<label for="employeeNum" class="layui-form-label label-define"> <span
				...
				<div class="layui-form-item">
					<div class="layui-col-md4">
						<label for="account" class="layui-form-label label-define"> <span
							class="x-red">*</span>订单状态
						</label>
						<div class="layui-input-inline">
				...
				<div class="layui-form-item">
					...
					<div class="layui-col-md4">
						<label for="account" class="layui-form-label label-define" style="width:120px"> <span
							class="x-red">*</span>收货人名称
						</label>
						<div class="layui-input-inline">
				...
				<div class="layui-form-item" id="btn">
					<button class="layui-btn layui-btn-danger layui-btn-radius"
						lay-filter="add" lay-submit id="close-btn" style="height: 45px;
	width: 134px;
	font-size: 16px;">点击关闭</button>
				</div>
			</form>
		</div>
	</div>
